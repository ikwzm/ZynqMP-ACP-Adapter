...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ACP_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ACP_AUSER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ACP_DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ACP_ID_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "ARSHARE_TYPE" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "AWSHARE_TYPE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_AUSER_BIT0_POS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_AUSER_BIT1_POS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_AUSER_WIDTH" -parent ${Page_0}
