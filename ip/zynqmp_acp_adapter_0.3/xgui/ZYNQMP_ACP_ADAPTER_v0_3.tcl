...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "READ_RESP_QUEUE" -parent ${READ}

  #Adding Group
  set WRITE [ipgui::add_group $IPINST -name "WRITE" -parent ${Page_0}]
  ipgui::add_param $IPINST -name "WRITE_ENABLE" -parent ${WRITE}
  ipgui::add_param $IPINST -name "WRITE_DATA_QUEUE" -parent ${WRITE}
  ipgui::add_param $IPINST -name "WRITE_MAX_LENGTH" -parent ${WRITE}
  ipgui::add_param $IPINST -name "WRITE_RESP_QUEUE" -parent ${WRITE}
