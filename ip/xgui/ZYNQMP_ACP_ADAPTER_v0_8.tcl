...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set CORE_PAGE [ipgui::add_page $IPINST -name "CORE"]

  #Adding Group
  set AXI_WIDTH  [ipgui::add_group $IPINST -name "AXI_WIDTH" -parent ${CORE_PAGE}]
  ...
  #Adding Group
  # set ACP_WIDTH  [ipgui::add_group $IPINST -name "ACP_WIDTH" -parent ${CORE_PAGE}]
  # ipgui::add_param $IPINST -name "ACP_ID_WIDTH"     -parent ${ACP_WIDTH}
  # ipgui::add_param $IPINST -name "ACP_DATA_WIDTH"   -parent ${ACP_WIDTH}
  # ipgui::add_param $IPINST -name "ACP_ADDR_WIDTH"   -parent ${ACP_WIDTH}
  # ipgui::add_param $IPINST -name "ACP_AUSER_WIDTH"  -parent ${ACP_WIDTH}

  #Adding Group
  set READ_ENABLE  [ipgui::add_group $IPINST -name "READ" -parent ${CORE_PAGE}]
  ipgui::add_param $IPINST -name "READ_ENABLE"      -parent ${READ_ENABLE}

  #Adding Group
  set WRITE_ENABLE [ipgui::add_group $IPINST -name "WRITE" -parent ${CORE_PAGE}]
  ipgui::add_param $IPINST -name "WRITE_ENABLE"     -parent ${WRITE_ENABLE}

  #Adding Page
  set READ_PAGE [ipgui::add_page $IPINST -name "READ"]
    
  #Adding Group
  set READ_CACHE [ipgui::add_group $IPINST -name "READ_CACHE" -parent ${READ_PAGE}]
  ipgui::add_param $IPINST -name "ARCACHE_OVERLAY"    -parent ${READ_CACHE}
  ipgui::add_param $IPINST -name "ARCACHE_VALUE"      -parent ${READ_CACHE}

  #Adding Group
  set READ_PROT  [ipgui::add_group $IPINST -name "READ_PROT"  -parent ${READ_PAGE}]
  ipgui::add_param $IPINST -name "ARPROT_OVERLAY"     -parent ${READ_PROT}
  ipgui::add_param $IPINST -name "ARPROT_VALUE"       -parent ${READ_PROT}

  #Adding Group
  set READ_SHARE [ipgui::add_group $IPINST -name "READ_SHARE" -parent ${READ_PAGE}]
  ipgui::add_param $IPINST -name "ARSHARE_TYPE"       -parent ${READ_SHARE}

  #Adding Group
  set READ_REGS  [ipgui::add_group $IPINST -name "READ_REGS"  -parent ${READ_PAGE}]
  ...
  #Adding Page
  set WRITE_PAGE [ipgui::add_page $IPINST -name "WRITE"]
    
  #Adding Group
  set WRITE_CACHE [ipgui::add_group $IPINST -name "WRITE_CACHE" -parent ${WRITE_PAGE}]
  ...
  #Adding Group
  set WRITE_PROT  [ipgui::add_group $IPINST -name "WRITE_PROT"  -parent ${WRITE_PAGE}]
  ipgui::add_param $IPINST -name "AWPROT_OVERLAY"     -parent ${WRITE_PROT}
  ipgui::add_param $IPINST -name "AWPROT_VALUE"       -parent ${WRITE_PROT}

  #Adding Group
  set WRITE_SHARE [ipgui::add_group $IPINST -name "WRITE_SHARE" -parent ${WRITE_PAGE}]
  ipgui::add_param $IPINST -name "AWSHARE_TYPE"       -parent ${WRITE_SHARE}

  #Adding Group
  set WRITE_REGS [ipgui::add_group $IPINST -name "WRITE_REGS"   -parent ${WRITE_PAGE}]
